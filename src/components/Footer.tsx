...
export default function Footer() {
  return (
    <div className="shadow-lg p-16 mb-5 bg-body rounded bg-green-500">
      <footer className="footer text-base-content p-10">
        <nav className="text-blak font-bold text-2xl">
        ...
        <nav className="text-white font-bold text-xl">
        ...
        <form>
          <h6 className="footer-title font-bold text-xl">Newsletter</h6>
